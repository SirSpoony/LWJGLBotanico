...
public class Item
{
    ...
    public static void initRegistry() {
        ...
        REGISTRY.register(new ItemBuilding(130, itemBounds(3), "tool_station", Buildings.TOOL_STATION, 5));
        REGISTRY.register(new ItemBuilding(131, itemBounds(7), "knapping_station", Buildings.KNAPPING_STATION, 5));
        ...
        REGISTRY.register(new ItemBuilding(14, itemBounds(19), "mystic_flower", Buildings.MYSTIC_FLOWER, 50));
        REGISTRY.register(new ItemBuilding(15, itemBounds(20), "energy_pipe", Buildings.ENERGY_PIPE, 50));
    ...
    private static IntRectangle itemBounds(int pos) {
        return new IntRectangle(pos*16, 0, 16, 16); // TODO wrapping
    }
