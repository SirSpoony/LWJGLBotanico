...
//===============
        renderRules.addRule(
                ...
                new TileMatcher(Direction.UP, TileMatcherType.REQUIRE, connection)).setBackground(background);
        ...
        renderRules.addRule(
                ...
                new TileMatcher(Direction.RIGHT, TileMatcherType.REQUIRE, connection),
                new TileMatcher(Direction.LEFT, TileMatcherType.REQUIRE, connection),
                new TileMatcher(Direction.UP, TileMatcherType.EXCEPT, connection)).setBackground(background);
